...
public class AuthController {
    ...
    public ResponseEntity<String> registerWithOrganization(@RequestBody RegisterWithOrganizationRequestDto request) {
    ...
    public ResponseEntity<String> registerTenant(@RequestBody RegisterTenantRequestDto request) {
        registerService.registerWithTenant(request);
        return new ResponseEntity<>("User and Tenant registered successfully!", HttpStatus.OK);
    }
}
